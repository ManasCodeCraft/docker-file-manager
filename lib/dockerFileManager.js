...
var DockerFileManager = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    console.error("Failed to detect platform: ".concat(err.message));
                }
                return [2 /*return*/, 'linux'];
            });
        });
        ...
        return __awaiter(this, arguments, void 0, function (filePath, content) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        console.error("Failed to create file ".concat(filePath, ": ").concat(err_1.message));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        console.error("Failed to rename file ".concat(oldPath, " to ").concat(newPath, ": ").concat(err_2.message));
                        return [2 /*return*/, false];
                    case 4: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        console.error("Failed to delete file ".concat(filePath, ": ").concat(err_3.message));
                        return [2 /*return*/, false];
                    case 4: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        console.error("Failed to create folder ".concat(folderPath, ": ").concat(err_4.message));
                        return [2 /*return*/, false];
                    case 4: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        console.error("Failed to rename folder ".concat(oldPath, " to ").concat(newPath, ": ").concat(err_5.message));
                        return [2 /*return*/, false];
                    case 4: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_6 = _a.sent();
                        console.error("Failed to delete folder ".concat(folderPath, ": ").concat(err_6.message));
                        return [2 /*return*/, false];
                    case 4: return [2 /*return*/];
                }
            });
    ...
    DockerFileManager.prototype.getFileStats = function (filePath) {
        return __awaiter(this, void 0, void 0, function () {
            var platform, statsCommand, stats, err_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 5:
                        err_7 = _a.sent();
                        console.error("Failed to get file stats for ".concat(filePath, ": ").concat(err_7.message));
                        return [2 /*return*/, null];
